...
In this demo project we implement the example revenue model defined in [How to think about monetization](./documentation/how-to-think-about-monetization.md#revenue_model) to show how this can be implemented by integrating Azure API Management (APIM) with Stripe.
